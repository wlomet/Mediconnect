...
const CreateGestionnaireModal = ({ onClose, onSuccess }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    setLoading(true);
    try {
      await axiosInstance.post("/super-admin/gestionnaires/create", {
        name: formData.name,
    ...
    <div style={modalOverlayStyle} onClick={onClose}>
      <div style={modalStyle} onClick={(e) => e.stopPropagation()}>
        <div style={modalHeaderStyle}>
          <h2 style={{ margin: 0, fontSize: "1.5rem" }}>Créer un Gestionnaire</h2>
...
export default CreateGestionnaireModal;
